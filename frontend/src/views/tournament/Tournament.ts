...
export class Tournament extends AView {
  ...
  public render(parent: HTMLElement = document.body): void {
    ...
    private renderStartTournament(contentContainer: HTMLElement) {
    ...
    private async checkTournamentState(contentContainer: HTMLElement): Promise<void> {
        ...
        if (forceNew) {
            ...
            this.renderStartTournament(contentContainer);
            // Listen for language change and re-create the element
            if (!this.languageListener) {
